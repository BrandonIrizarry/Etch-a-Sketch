...
* Priorities <2023-01-09 Mon> [/]
  1. [ ] The "patch" for avoiding duplicate grid creation has bit me a
     ...
     board on rotation.
  2. [ ] The rotation hook should include a change in the vertical
